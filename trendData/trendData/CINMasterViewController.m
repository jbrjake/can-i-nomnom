...
#import "CINDetailViewController.h"

@interface CINMasterViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation CINMasterViewController
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (CINDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"trend" ascending:NO];
